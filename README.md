# yawp ][
[yawp](https://github.com/apple-fritter/yawp/blob/main/yawp.sh), the predecessor had a good reception following it's first commits. I wanted to leave it be, and update some of my strategies employed by such a script, and write something new.
